...
#used table to see if values were marked as NA or as empty (they were empty)
#table(titanic$embarked)

#change empty values to "S"
titanic$embarked[titanic$embarked == ""] <- "S"

# remove "" level from port of embarkation column (it now contains 0 values)
...
#change empty values to None, than use mutate
titanic$cabin[titanic$cabin == ""] <- "None"
